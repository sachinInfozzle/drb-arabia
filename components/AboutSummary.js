...
export default function AboutSummary({ data }) {
  ...
  return (
    <>
      <section
        className="aboutus-about-drb about-section custom-rtl"
        style={{ order: Position }}
      >
        <div className="container">
          <div className="row align-items-end custom-row-reverse custom-reverse-sachin">
            ...
            <div className="content-blk text-start aos" data-aos="fade-up">
              <FadeUpWrapper>
                <div className="section-header text-start position-relative">
                  ...
                  <img
                    src="https://drbarabia.com/uploads/shape_01_4c799d8b54.png"

  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        const fetchUrl = `${apiUrl}/api/pages/${id}?locale=${locale}&populate=Book_Now_Button&populate=Sections.Form&populate=Sections.contents&populate=Sections.Image&populate=Sections.Location&populate=Sections.RightImage&populate=Sections.LeftImage&populate=Sections.Content&populate=Sections.TitleImage&populate=Sections.FirstImage&populate=Sections.SecondImage&populate=Sections.ThirdImage&populate=Sections.image&populate=Sections.Button&populate=Sections.privetEventImage&populate=Sections.corporateEventImage&populate=Sections.images&populate=Sections.Title&populate=Sections.ExperienceItem.Image&populate=Sections.Image`;
